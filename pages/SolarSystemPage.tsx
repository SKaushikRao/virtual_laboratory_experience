...
const SolarSystemScene = ({ handState }: { handState: React.MutableRefObject<TrackingState> }) => {
...
const SolarSystemPage: React.FC<SolarSystemPageProps> = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-gradient-to-br from-purple-900 via-black to-blue-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          <SolarSystemScene handState={handStateRef} />
        </Canvas>
      </div>
      ...
      <div className="absolute bottom-8 left-8 bg-black/60 backdrop-blur-xl border border-white/10 rounded-xl p-4 max-w-md">
        <h3 className="text-lg font-bold mb-3 text-purple-400">CONTROLS</h3>
        <div className="space-y-2 text-sm font-mono">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
            <span>Fist: Full view</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
            <span>1-5 fingers: Navigate planets</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
            <span>Pinch: Orbit camera</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2 text-center">
        ...
        <p className="text-gray-300 text-sm mt-1">Cosmic Navigation</p>
      </div>
    </div>
  );
};
